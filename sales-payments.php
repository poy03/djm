...
if($_POST){
	...
	$id = @$_POST["id"];
		...
		mysql_query("UPDATE tbl_payments SET payment='$value' WHERE type_payment LIKE '%$type_payment_post%' AND orderID='$orderID'");
		mysql_query("UPDATE tbl_payments SET date='$datenow', time='$timenow' WHERE orderID='$orderID'");
