...
<div class="container-fluid">
  ...
  <div class='row'>
	...
	<ol class="breadcrumb">
		...
		<li><a href="sales-list">List of DR</a></li>
	...
	<button class='btn btn-primary btn-block' name='save'  tabindex='-1'><span class='glyphicon glyphicon-floppy-disk'></span> Save & Continue</button>
