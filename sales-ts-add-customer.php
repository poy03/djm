...
if(isset($customerID)){
	...
	mysql_query("UPDATE tbl_ts_cart SET customerID='$customerID', Customer='$customername', terms='$terms' WHERE accountID='$accountID'");
	header("location:sales-ts");
}elseif(isset($customer)){
	mysql_query("UPDATE tbl_ts_cart SET customerID='0', Customer='$customer', terms='0' WHERE accountID='$accountID'");
	header("location:sales-ts");
}else{
	header("location:sales-ts");
}
