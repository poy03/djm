   ...
   <div class = "modal-dialog">
	...
	while($purchaserow=mysql_fetch_assoc($purchasequery)){
		...
		<tr>
			...
			<td style='padding:0px'>$quantity</td>
			<td align='right' colspan='2' style='padding:0px'>₱".number_format($price,2)."</td>
	...
	<tr  style='text-align:right;'>
		<td colspan='4' align='right' style='padding:0px'><b>Total:</b></td>
	...
	<?php
		...
		if(mysql_num_rows($payment_query)!=0){
			while($payment_row=mysql_fetch_assoc($payment_query)){
				...
				echo "
					<tr style='text-align:right;'>
						<td colspan='3' align='right' style='border:0px;padding:0px'><span id='$type_payment' class='comments'>$ref_num</span></td>
...
echo "
		<div class='col-md-4'>
		<a class='btn btn-danger btn-block' href='sales-edit?id=$orderID'><span class='glyphicon glyphicon-edit'></span> Return Items</a>
		</div>
