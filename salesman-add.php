...
if(isset($_POST["submit"])){
		$salesman_name = mysql_real_escape_string(htmlspecialchars(trim($_POST["salesman_name"])));
		$salesman_address = mysql_real_escape_string(htmlspecialchars(trim($_POST["salesman_address"])));
		$salesman_contact_number = mysql_real_escape_string(htmlspecialchars(trim($_POST["salesman_contact_number"])));
		$searchquery = mysql_query("SELECT * FROM tbl_salesman WHERE salesman_name='$salesman_name' AND deleted = '0'");
		if(mysql_num_rows($searchquery)<1){
			mysql_query("INSERT INTO tbl_salesman VALUES('','$salesman_name','$salesman_address','$salesman_contact_number','','','','')");
		echo "
				<div class = 'alert alert-success alert-dismissable'>
				   ...
				   <strong>$salesman_name</strong> is successfuly saved.
				</div>
		...
		echo "
				<div class = 'alert alert-danger alert-dismissable'>
				   ...
				   <strong>$salesman_name</strong> is already added.
				</div>
	...
	?>
	<form action="salesman-add" method='post' class='form-horizontal'>	
	<div class='col-md-2'>
	...
	<div class='form-group'>
		<label for="salesman_name" class='col-md-3'>Salesman's Name:</label>
	<div class='col-md-9'>
	...
	<div class='form-group'>
		<label for="salesman_contact_number" class='col-md-3'>Contact Number:</label>
	<div class='col-md-9'>
		<input type='number' class='form-control' name='salesman_contact_number' placeholder='Contact Number'>
	</div>
	</div>

	<div class='form-group'>
		<label for="salesman_address" class='col-md-3'>Salesman's Address:</label>
	<div class='col-md-9'>
