...
<div class="container-fluid">
  <div class='row'>
	...
	<div class='col-md-2'>
	<?php if($suppliers_add=='1'||$suppliers_modify=='1'){
		echo "<label>Controls:</label>";
	}?>
	<?php if($suppliers_add=='1'){
		echo "<span class='btn btn-primary btn-block' name='add' id='add'><span class='glyphicon glyphicon-phone'></span> Add Suppliers</span>";
	}?>
