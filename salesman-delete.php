  ...
  <div class='row'>
	...
	if($salesman=='1'){
		...
		foreach($x as $customerID){
			mysql_query("UPDATE tbl_salesman SET deleted = '1' WHERE salesmanID='$customerID'");
		}
		echo "
				<div class = 'alert alert-success'>	
				   <center>salesmans are successfully deleted. <a href='salesman'>Back to salesman.</a></center>
				</div>
		";
		}else{
