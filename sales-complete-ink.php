  ...
  <div class='row'>
	...
	if($logged==1||$logged==2){
		if($sales=='1'||$reports=='1'){
			...
			echo "
				<center style='font-size:18pt;font-weight:bold;text-align:center'><u>".strtoupper($app_company_name)."</u></center>
				...
				<table style='width:100%' style=''>
					<tr>
						<th colspan='20'>DELIVERY RECEIPT<img src='$logo' style='height:50px;position:absolute;right:0;padding-right:25px'></th>
					...
					<tr>
						...
						<th>".$salesman_data["salesman_name"]."</th>
					</tr>
					<tr>
						<th>Date:</th>
						<th style='width:30%;border-bottom-width:2px;border-bottom-style:solid'>".date("F d, Y",$order_data["date_ordered"])."</th>
						<th style='width:50%;'></th>
					</tr>
					<tr>
						<th>Customer Name</th>
						<th style='border-bottom-width:2px;border-bottom-style:solid' colspan='2'>".$customer_data["companyname"]."</th>
					</tr>
					<tr>
						<th>Delivery Address</th>
						<th style='border-bottom-width:2px;border-bottom-style:solid' colspan='2'>".$customer_data["address"]."</th>
					</tr>
					<tr>
				...
				<table style='width:98%;margin-left:auto;margin-right:auto;' class='order_details'>
					...
					<tr>
						...
						<th style='border-right-width:0px;border-top-width:0px;border-left-width:0px;'><input type='text' class='date_delivered' id='$orderID' value='".date("m/d/Y",$order_data["date_delivered"])."' style='width:100%' readonly></th>
					</tr>
					<tr>
			...
			if($order_data["deleted"]==0){
				echo "<a href='sales-complete?id=$orderID' class='btn btn-warning btn-lg'>Print in Dot-Matrix</a>";	
